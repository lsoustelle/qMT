...
The user interfaces for both constructors are designed to match the parameters to be passed in the *fit-JSPqMT* script. The latter is intended to be used with MT-weighted data prepared with sine-modulated off-resonance pulses [1].
...
* In *fit-SPqMT*, two presets of constraint qMT parameters are proposed for adult human brain at 3T [5] and adult mouse brain at 7T [8].
